...
const bannerLogIn = () => {
    return (      
            <div class=" h-screen flex-1 bg-red-600 bg-primary-600 flex flex-col justify-between px-40 ">
                <h1 class="font-bold text-4xl text-white mx-4  text-center mt-6">WELCOME TO</h1>
                <h1 class="font-bold text-4xl text-white mx-4  text-center mt-2 ">- HEAVEN OF BOOKS -</h1>
                <div>
